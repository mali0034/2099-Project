...
import game.PickUpFruitFromBushAction;
import game.PickUpFruitFromTreeAction;
...
public abstract class Item implements ItemInterface, Printable, Capable {
	...
	public PickUpFruitFromBushAction getPickUpFruitFromBushAction() {
		if(portable)
			return new PickUpFruitFromBushAction(this);

		return null;
	}
	public PickUpFruitFromTreeAction getPickUpFruitFromTreeAction() {
		if(portable)
			return new PickUpFruitFromTreeAction(this);
